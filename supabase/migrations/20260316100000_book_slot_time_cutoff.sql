-- ─── Aggiunge controllo orario a book_slot_atomic ────────────────────────────
-- Blocca prenotazioni se sono passati più di 30 minuti dall'inizio della lezione.
-- Il check precedente controllava solo la data (giorno), non l'ora.
...
BEGIN
    ...
    -- p_time ha formato "HH:MM - HH:MM"; estraiamo l'orario di inizio
