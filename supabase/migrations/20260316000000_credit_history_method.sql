-- ─── Aggiunge colonna method a credit_history ───────────────────────────────
-- Permette di tracciare il metodo di pagamento (carta, iban, contanti, ecc.)
-- usato quando si aggiunge credito manuale. Necessario per il report settimanale.

ALTER TABLE credit_history
    ADD COLUMN IF NOT EXISTS method TEXT NOT NULL DEFAULT '';

-- ─── Aggiorna la RPC admin_add_credit per salvare il method ─────────────────
...
BEGIN
    ...
    -- ── 3. Inserisce voce in credit_history (ora con method) ────────────────
